...
namespace maxcare
{
	public class fHDDangXuatThietBiCu : Form
	{
		...
		public fHDDangXuatThietBiCu(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			if (type == 0)
			{
				...
				{
					if (InteractSQL.InsertHanhDong(id_KichBan, text, id_TuongTac, cauHinh))
					{
						isSave = true;
						Close();
					}
			...
			{
				if (InteractSQL.UpdateHanhDong(Id_HanhDong, text, cauHinh))
				{
					isSave = true;
					Close();
				}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDDangXuatThietBiCu));
