...
namespace maxcare
{
	public class fHDChucMungSinhNhat : Form
	{
		...
		private void ChangeLanguage()
		{
			...
			Language.GetValue(rbNhanTin);
			Language.GetValue(rbDangBai);
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				...
				if (Convert.ToInt32(setting["typeAction"]) == 0)
				{
				...
				txtContent.Text = setting["txtContent"]!.ToString();
			}
			catch
			{
			}
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			List<string> lst = txtContent.Lines.ToList();
			...
			jSON_Settings.Update("txtContent", txtContent.Text.Trim());
		...
		private void txtComment_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtContent.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				lblStatus.Text = string.Format(Language.GetValue("Danh sa\u0301ch tin nhă\u0301n/ba\u0300i viê\u0301t ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		{
			MessageBoxHelper.ShowMessageBox(Language.GetValue("Có thể dùng [u] để thay thế tên của người nhận!"));
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDChucMungSinhNhat));
			...
			bunifuCustomLabel1.Text = "Cấu hình Chúc mừng sinh nhật";
			...
			txtContent.Location = new System.Drawing.Point(31, 191);
			txtContent.Multiline = true;
			txtContent.Name = "txtContent";
			txtContent.ScrollBars = System.Windows.Forms.ScrollBars.Both;
			txtContent.Size = new System.Drawing.Size(295, 138);
			...
			label4.Location = new System.Drawing.Point(286, 82);
			label4.Name = "label4";
