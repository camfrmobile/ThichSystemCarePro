...
namespace maxcare
{
	public class fHDMoiBanBeLikePage : Form
	{
		...
		public fHDMoiBanBeLikePage(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				nudSoLuongFrom.Value = setting.GetValueInt("nudSoLuongFrom", 5);
		...
		private void txtComment_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtUid.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				lblStatus.Text = string.Format(Language.GetValue("Danh sa\u0301ch Uid page cần mơ\u0300i ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDMoiBanBeLikePage));
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(362, 371);
			panel1.TabIndex = 0;
			panel1.Paint += new System.Windows.Forms.PaintEventHandler(panel1_Paint);
			txtUid.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			txtUid.Location = new System.Drawing.Point(31, 126);
			txtUid.Name = "txtUid";
			txtUid.Size = new System.Drawing.Size(295, 167);
			txtUid.TabIndex = 114;
			txtUid.Text = "";
			...
			lblStatus.Location = new System.Drawing.Point(27, 106);
			lblStatus.Name = "lblStatus";
			lblStatus.Size = new System.Drawing.Size(196, 16);
			lblStatus.TabIndex = 0;
			lblStatus.Text = "Danh sa\u0301ch Uid page cần mơ\u0300i (0):";
			...
			btnAdd.Location = new System.Drawing.Point(82, 329);
			btnAdd.Name = "btnAdd";
