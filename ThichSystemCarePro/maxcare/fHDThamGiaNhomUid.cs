	...
	public class fHDThamGiaNhomUid : Form
	{
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				...
				ckbTuDongXoaUid.Checked = Convert.ToBoolean(setting["ckbThamGiaNhomTrungNhau"]);
				txtUid.Text = setting["txtUid"]!.ToString();
				ckbTuDongTraLoiCauHoi.Checked = Convert.ToBoolean(setting["ckbTuDongTraLoiCauHoi"]);
				ckbTuDongXoaUid.Checked = Convert.ToBoolean(setting["ckbTuDongXoaUid"]);
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			jSON_Settings.Update("ckbThamGiaNhomTrungNhau", ckbTuDongXoaUid.Checked);
		...
		private void txtComment_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtUid.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				lblStatus.Text = string.Format(Language.GetValue("Danh sa\u0301ch Uid nhóm cần tham gia ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDThamGiaNhomUid));
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(690, 402);
			panel1.TabIndex = 0;
			...
			label9.Location = new System.Drawing.Point(3, 158);
			label9.Name = "label9";
			label9.Size = new System.Drawing.Size(134, 16);
			label9.TabIndex = 0;
			label9.Text = "(Mỗi nội dung 1 dòng)";
			...
			ckbTuDongTraLoiCauHoi.Location = new System.Drawing.Point(30, 139);
			...
			ckbTuDongXoaUid.Location = new System.Drawing.Point(355, 324);
			ckbTuDongXoaUid.Name = "ckbTuDongXoaUid";
			ckbTuDongXoaUid.Size = new System.Drawing.Size(299, 20);
			...
			lblStatus.Size = new System.Drawing.Size(229, 16);
			...
			btnAdd.Location = new System.Drawing.Point(248, 359);
			btnAdd.Name = "btnAdd";
