...
namespace maxcare
{
	public class fChangeInfo : Form
	{
			...
			try
			{
				...
				else
				{
					while (true)
					{
						...
						default:
						{
							SetStatusAccount(indexRow, text2 + Language.GetValue("Đang") + " Up Avatar...", device);
							bool flag11 = false;
							int num8 = 0;
							string html = "";
							num8 = 1;
							...
							while (true)
							{
								...
								flag11 = device.TapByText("profile picture", "", 10);
								while (flag11)
								{
									num8++;
									switch (num8)
									...
									case 3:
										...
										flag11 = device.WaitForTextDisappear(60.0, "uploading your profile photo.");
										continue;
									case 1:
										break;
									}
		...
		{
			MCommon.Common.ShowForm(new fChangeInfo_CauHinh());
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fChangeInfo));
			...
			bunifuCustomLabel1.Text = "MAX SYSTEM CARE PRO - Ti\u0301nh năng Đô\u0309i thông tin";
