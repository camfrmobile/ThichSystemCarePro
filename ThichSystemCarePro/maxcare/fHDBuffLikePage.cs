...
namespace maxcare
{
	public class fHDBuffLikePage : Form
	{
		...
		public fHDBuffLikePage(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDBuffLikePage").Rows.Count == 0)
			{
				maxcare.KichBan.Connector.Instance.ExecuteNonQuery("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDBuffLikePage', 'Buff Like Page');");
			}
			...
			case 0:
			{
				DataTable tuongTac = InteractSQL.GetTuongTac("", "HDBuffLikePage");
		...
		private void InitializeComponent()
		{
			...
			bunifuCustomLabel1.Text = "Cấu hình Buff Like Page";
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(346, 159);
			panel1.TabIndex = 0;
