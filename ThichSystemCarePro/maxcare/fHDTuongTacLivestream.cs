...
namespace maxcare
{
	public class fHDTuongTacLivestream : Form
	{
		...
		public fHDTuongTacLivestream(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDTuongTacLivestream));
			...
			nudBinhLuanNhieuLanDelayTo.Location = new System.Drawing.Point(166, 2);
			...
			label5.TabIndex = 20;
			label5.Text = "giây";
			label6.Location = new System.Drawing.Point(135, 4);
			label6.Name = "label6";
