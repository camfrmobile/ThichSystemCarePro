...
namespace maxcare
{
	public class fHDNhanTinBanBe : Form
	{
		...
		private void ChangeLanguage()
		{
			...
			Language.GetValue(rbUidChiDinh);
			Language.GetValue(rbTrucTuyen);
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				...
				txtTinNhan.Text = setting["txtTinNhan"]!.ToString();
				switch (Convert.ToInt32(setting["typeDoiTuong"]))
				{
				case 0:
				...
				txtUidChiDinh.Text = setting["txtUidChiDinh"]!.ToString();
			}
			catch
			{
			}
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			List<string> lst = txtTinNhan.Lines.ToList();
			...
			{
				lst = txtUidChiDinh.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				if (lst.Count == 0)
				{
			...
			jSON_Settings.Update("txtTinNhan", txtTinNhan.Text.Trim());
			...
			jSON_Settings.Update("txtUidChiDinh", txtUidChiDinh.Text.Trim());
		...
		private void txtComment_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtTinNhan.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				lblStatus.Text = string.Format(Language.GetValue("Danh sa\u0301ch tin nhă\u0301n ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		private void txtComment_TextChanged_1(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtUidChiDinh.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				lblStatusUid.Text = string.Format(Language.GetValue("Danh sách UID ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		{
			MessageBoxHelper.ShowMessageBox(Language.GetValue("Có thể dùng [u] để thay thế tên của người nhận tin nhắn!"));
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDNhanTinBanBe));
			...
			rbUidChiDinh = new System.Windows.Forms.RadioButton();
			...
			plUidChiDinh.Controls.Add(label10);
			...
			txtUidChiDinh.TextChanged += new System.EventHandler(txtComment_TextChanged_1);
			label10.AutoSize = true;
			label10.Location = new System.Drawing.Point(4, 141);
			...
			rbUidChiDinh.AutoSize = true;
			rbUidChiDinh.Cursor = System.Windows.Forms.Cursors.Hand;
			rbUidChiDinh.Location = new System.Drawing.Point(375, 94);
			rbUidChiDinh.Name = "rbUidChiDinh";
			rbUidChiDinh.Size = new System.Drawing.Size(94, 20);
			rbUidChiDinh.TabIndex = 48;
			rbUidChiDinh.Text = "UID chỉ định";
			rbUidChiDinh.UseVisualStyleBackColor = true;
			rbUidChiDinh.CheckedChanged += new System.EventHandler(rbUidChiDinh_CheckedChanged);
			...
			rbTrucTuyen.CheckedChanged += new System.EventHandler(rbNgauNhien_CheckedChanged);
			rbNgauNhien.AutoSize = true;
			rbNgauNhien.Checked = true;
			rbNgauNhien.Cursor = System.Windows.Forms.Cursors.Hand;
			rbNgauNhien.Location = new System.Drawing.Point(375, 71);
			rbNgauNhien.Name = "rbNgauNhien";
			rbNgauNhien.Size = new System.Drawing.Size(177, 20);
			rbNgauNhien.TabIndex = 48;
			rbNgauNhien.TabStop = true;
			rbNgauNhien.Text = "Ngẫu nhiên danh sách bạn";
			rbNgauNhien.UseVisualStyleBackColor = true;
			rbNgauNhien.CheckedChanged += new System.EventHandler(rbNgauNhien_CheckedChanged);
			label9.AutoSize = true;
			label9.Location = new System.Drawing.Point(372, 49);
			label9.Name = "label9";
			label9.Size = new System.Drawing.Size(173, 16);
			label9.TabIndex = 47;
			label9.Text = "Tùy chọn đối tượng nhắn tin:";
			txtTinNhan.Location = new System.Drawing.Point(31, 158);
			txtTinNhan.Multiline = true;
			txtTinNhan.Name = "txtTinNhan";
			txtTinNhan.ScrollBars = System.Windows.Forms.ScrollBars.Both;
			txtTinNhan.Size = new System.Drawing.Size(295, 107);
			txtTinNhan.TabIndex = 5;
			txtTinNhan.WordWrap = false;
			txtTinNhan.TextChanged += new System.EventHandler(txtComment_TextChanged);
			...
			btnAdd.Location = new System.Drawing.Point(246, 305);
			btnAdd.Name = "btnAdd";
			...
			button2.Location = new System.Drawing.Point(304, 265);
