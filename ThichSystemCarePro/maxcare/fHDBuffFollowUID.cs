...
namespace maxcare
{
	public class fHDBuffFollowUID : Form
	{
		...
		public fHDBuffFollowUID(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDBuffFollowUID").Rows.Count == 0)
			{
				maxcare.KichBan.Connector.Instance.ExecuteNonQuery("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDBuffFollowUID', 'Buff Follow UID');");
			}
			...
			case 0:
			{
				DataTable tuongTac = InteractSQL.GetTuongTac("", "HDBuffFollowUID");
