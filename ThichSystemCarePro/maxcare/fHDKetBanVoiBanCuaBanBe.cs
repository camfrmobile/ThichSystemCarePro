...
namespace maxcare
{
	public class fHDKetBanVoiBanCuaBanBe : Form
	{
		...
		public fHDKetBanVoiBanCuaBanBe(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDKetBanVoiBanCuaBanBe").Rows.Count == 0)
			{
		...
		private void InitializeComponent()
		{
			...
			nudTimesWarning.Location = new System.Drawing.Point(253, 220);
			...
			label8.Location = new System.Drawing.Point(27, 222);
			label8.Name = "label8";
			...
			btnCancel.Location = new System.Drawing.Point(193, 146);
