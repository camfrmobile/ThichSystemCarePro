...
namespace maxcare
{
	public class fHDNhanTinPage : Form
	{
		...
		private void ChangeLanguage()
		{
			...
			Language.GetValue(lblStatusPage);
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				...
				txtIdPage.Text = setting["txtIdPage"]!.ToString();
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			List<string> lst = txtIdPage.Lines.ToList();
		...
		private void textBox1_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtIdPage.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				lblStatusPage.Text = string.Format(Language.GetValue("Danh sa\u0301ch ID Page ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDNhanTinPage));
			...
			lblStatusPage = new System.Windows.Forms.Label();
			...
			panel1.Controls.Add(lblStatusPage);
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(362, 500);
			panel1.TabIndex = 0;
			panel1.Paint += new System.Windows.Forms.PaintEventHandler(panel1_Paint);
			txtTinNhan.Location = new System.Drawing.Point(31, 286);
			...
			btnCancel.Location = new System.Drawing.Point(185, 456);
			...
			lblStatusPage.AutoSize = true;
			lblStatusPage.Location = new System.Drawing.Point(28, 139);
			lblStatusPage.Name = "lblStatusPage";
			lblStatusPage.Size = new System.Drawing.Size(141, 16);
			lblStatusPage.TabIndex = 0;
			lblStatusPage.Text = "Danh sa\u0301ch ID Page (0):";
			...
			txtIdPage.TextChanged += new System.EventHandler(textBox1_TextChanged);
