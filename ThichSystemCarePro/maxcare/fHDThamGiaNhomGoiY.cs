...
namespace maxcare
{
	public class fHDThamGiaNhomGoiY : Form
	{
		...
		public fHDThamGiaNhomGoiY(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDThamGiaNhomGoiY").Rows.Count == 0)
			{
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				...
				ckbTuDongTraLoiCauHoi.Checked = setting.GetValueBool("ckbTuDongTraLoiCauHoi");
				txtCauTraLoi.Text = setting.GetValue("txtCauTraLoi");
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			bunifuCustomLabel1.Text = "Cấu hình Tham gia nhóm gợi ý";
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(366, 398);
			panel1.TabIndex = 0;
			...
			btnCancel.Location = new System.Drawing.Point(193, 355);
			...
			btnAdd.Location = new System.Drawing.Point(86, 355);
			btnAdd.Name = "btnAdd";
