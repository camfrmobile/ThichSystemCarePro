...
namespace maxcare
{
	public class fHDTuongTacNhom : Form
	{
		...
		public fHDTuongTacNhom(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
			...
			{
				maxcare.KichBan.Connector.Instance.ExecuteNonQuery("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDTuongTacNhom', '" + Language.GetValue("Tương tác Nhóm") + "');");
			}
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				nudSoLuongNhomFrom.Value = setting.GetValueInt("nudSoLuongNhomFrom", 1);
				nudSoLuongNhomTo.Value = setting.GetValueInt("nudSoLuongNhomTo", 3);
		...
		private void InitializeComponent()
		{
			...
			btnCancel.Location = new System.Drawing.Point(189, 432);
			...
			btnAdd.Location = new System.Drawing.Point(82, 432);
			btnAdd.Name = "btnAdd";
			...
			button2.Location = new System.Drawing.Point(224, 161);
