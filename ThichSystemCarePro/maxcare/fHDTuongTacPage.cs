...
namespace maxcare
{
	public class fHDTuongTacPage : Form
	{
		...
		public fHDTuongTacPage(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDTuongTacPage").Rows.Count == 0)
			{
				maxcare.KichBan.Connector.Instance.ExecuteNonQuery("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDTuongTacPage', 'Tương tác Page');");
			}
			...
			case 0:
			{
				DataTable tuongTac = InteractSQL.GetTuongTac("", "HDTuongTacPage");
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				...
				nudSoLuongPageFrom.Value = setting.GetValueInt("nudSoLuongPageFrom", 1);
				nudSoLuongPageTo.Value = setting.GetValueInt("nudSoLuongPageTo", 3);
		...
		private void txtUid_TextChanged(object sender, EventArgs e)
		{
			try
			{
				...
				lst = MCommon.Common.RemoveEmptyItems(lst);
				lblUid.Text = "Danh sa\u0301ch Uid Page (" + lst.Count + "):";
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			ckbTuDongXoaUid.Location = new System.Drawing.Point(24, 371);
			ckbTuDongXoaUid.Name = "ckbTuDongXoaUid";
			ckbTuDongXoaUid.Size = new System.Drawing.Size(229, 20);
			ckbTuDongXoaUid.TabIndex = 128;
			ckbTuDongXoaUid.Text = "Tư\u0323 đô\u0323ng xo\u0301a Uid page đa\u0303 tương tác";
			...
			lblUid.Location = new System.Drawing.Point(21, 110);
			lblUid.Name = "lblUid";
			lblUid.Size = new System.Drawing.Size(147, 16);
			lblUid.TabIndex = 126;
			lblUid.Text = "Danh sa\u0301ch Uid Page (0):";
			...
			label18.Location = new System.Drawing.Point(275, 25);
			...
			plCountLike.Location = new System.Drawing.Point(116, 51);
			...
			label68.Location = new System.Drawing.Point(290, 82);
			...
			nudSoLuongPageTo.Location = new System.Drawing.Point(229, 80);
			...
			label66.Location = new System.Drawing.Point(194, 82);
			...
			btnAdd.Location = new System.Drawing.Point(241, 407);
			btnAdd.Name = "btnAdd";
