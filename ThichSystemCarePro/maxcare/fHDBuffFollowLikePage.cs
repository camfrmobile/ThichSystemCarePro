...
namespace maxcare
{
	public class fHDBuffFollowLikePage : Form
	{
		...
		public fHDBuffFollowLikePage(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDBuffFollowLikePage").Rows.Count == 0)
			{
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				ckbLike.Checked = Convert.ToBoolean(setting["ckbLike"]);
				ckbFollow.Checked = Convert.ToBoolean(setting["ckbFollow"]);
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			jSON_Settings.Update("ckbLike", ckbLike.Checked);
		...
		private void txtIdPost_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtUid.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				label2.Text = string.Format(Language.GetValue("Danh sa\u0301ch Uid Page ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDBuffFollowLikePage));
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(362, 440);
			panel1.TabIndex = 0;
			...
			txtUid.TextChanged += new System.EventHandler(txtIdPost_TextChanged);
			label2.AutoSize = true;
			label2.Location = new System.Drawing.Point(27, 153);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(147, 16);
			label2.TabIndex = 40;
			label2.Text = "Danh sa\u0301ch Uid Page (0):";
