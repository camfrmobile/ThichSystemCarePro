...
namespace maxcare
{
	public class fHDMoiBanBeVaoNhom : Form
	{
		...
		private void ChangeLanguage()
		{
			...
			Language.GetValue(rbInviteRandom);
			Language.GetValue(rbInviteSuggest);
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				if (setting.GetValueInt("typeInvite", 1) == 0)
				{
				...
				nudSoLuongFrom.Value = setting.GetValueInt("nudSoLuongFrom", 3);
				nudSoLuongTo.Value = setting.GetValueInt("nudSoLuongTo", 5);
				nudDelayFrom.Value = setting.GetValueInt("nudDelayFrom", 1);
				nudDelayTo.Value = setting.GetValueInt("nudDelayTo", 3);
				txtIdGroup.Text = setting.GetValue("txtIdGroup");
			}
			catch
			{
			}
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			jSON_Settings.Update("txtIdGroup", txtIdGroup.Text.Trim());
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDMoiBanBeVaoNhom));
			...
			txtIdGroup = new System.Windows.Forms.TextBox();
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(362, 263);
			panel1.TabIndex = 0;
			panel1.Paint += new System.Windows.Forms.PaintEventHandler(panel1_Paint);
			rbInviteSuggest.AutoSize = true;
			rbInviteSuggest.Cursor = System.Windows.Forms.Cursors.Hand;
			rbInviteSuggest.Location = new System.Drawing.Point(132, 167);
			rbInviteSuggest.Name = "rbInviteSuggest";
			rbInviteSuggest.Size = new System.Drawing.Size(136, 20);
			...
			rbInviteRandom.Location = new System.Drawing.Point(132, 191);
			rbInviteRandom.Name = "rbInviteRandom";
			rbInviteRandom.Size = new System.Drawing.Size(156, 20);
			...
			label5.Location = new System.Drawing.Point(27, 169);
			label5.Name = "label5";
			label5.Size = new System.Drawing.Size(90, 16);
			label5.TabIndex = 0;
			label5.Text = "Tùy chọn mời:";
			lblStatus.AutoSize = true;
			lblStatus.Location = new System.Drawing.Point(27, 141);
			lblStatus.Name = "lblStatus";
			lblStatus.Size = new System.Drawing.Size(94, 16);
			lblStatus.TabIndex = 0;
			lblStatus.Text = "Nhâ\u0323p ID nho\u0301m:";
			nudDelayTo.Location = new System.Drawing.Point(229, 109);
			...
			nudDelayFrom.Location = new System.Drawing.Point(132, 109);
			...
			label7.Location = new System.Drawing.Point(287, 111);
			label7.Name = "label7";
			...
			btnCancel.Location = new System.Drawing.Point(191, 223);
			...
			btnAdd.Location = new System.Drawing.Point(80, 223);
			btnAdd.Name = "btnAdd";
			...
			txtIdGroup.Size = new System.Drawing.Size(194, 23);
			txtIdGroup.TabIndex = 116;
			base.AutoScaleDimensions = new System.Drawing.SizeF(7f, 16f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			base.ClientSize = new System.Drawing.Size(362, 263);
