...
namespace maxcare
{
	public class fHDXemWatchTheoTuKhoa : Form
	{
		...
		public fHDXemWatchTheoTuKhoa(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDXemWatchTheoTuKhoa").Rows.Count == 0)
			{
				maxcare.KichBan.Connector.Instance.ExecuteNonQuery("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDXemWatchTheoTuKhoa', '" + Language.GetValue("Xem watch theo tư\u0300 kho\u0301a") + "');");
			}
			...
			case 0:
			{
				DataTable tuongTac = InteractSQL.GetTuongTac("", "HDXemWatchTheoTuKhoa");
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				...
				nudTimeWatchFrom.Value = setting.GetValueInt("nudTimeWatchFrom", 10);
				nudTimeWatchTo.Value = setting.GetValueInt("nudTimeWatchTo", 30);
		...
		private void richTextBox1_TextChanged(object sender, EventArgs e)
		{
			try
			{
				...
				lst = MCommon.Common.RemoveEmptyItems(lst);
				label16.Text = string.Format(Language.GetValue("({0})"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDXemWatchTheoTuKhoa));
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(362, 519);
			panel1.TabIndex = 0;
			...
			plCountComment.Location = new System.Drawing.Point(132, 264);
			...
			plCountShareWall.Location = new System.Drawing.Point(132, 236);
			...
			plCountLike.Location = new System.Drawing.Point(132, 208);
			...
			plComment.Location = new System.Drawing.Point(48, 292);
			...
			ckbComment.Location = new System.Drawing.Point(30, 266);
			...
			ckbShareWall.Location = new System.Drawing.Point(30, 238);
			...
			ckbInteract.Location = new System.Drawing.Point(30, 210);
			...
			nudTimeWatchTo.Location = new System.Drawing.Point(229, 181);
			...
			nudSoLuongTo.Location = new System.Drawing.Point(229, 154);
			nudSoLuongTo.Maximum = new decimal(new int[4] { 999999, 0, 0, 0 });
			nudSoLuongTo.Name = "nudSoLuongTo";
			nudSoLuongTo.Size = new System.Drawing.Size(56, 23);
			nudSoLuongTo.TabIndex = 2;
			nudTimeWatchFrom.Location = new System.Drawing.Point(132, 181);
			...
			nudSoLuongFrom.Location = new System.Drawing.Point(132, 154);
			...
			label7.Location = new System.Drawing.Point(194, 183);
			label7.Name = "label7";
			label7.Size = new System.Drawing.Size(29, 16);
			label7.TabIndex = 38;
			label7.Text = "đê\u0301n";
			label7.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			label3.Location = new System.Drawing.Point(194, 156);
			label3.Name = "label3";
			...
			label6.Location = new System.Drawing.Point(290, 183);
			label6.Name = "label6";
			label6.Size = new System.Drawing.Size(31, 16);
			label6.TabIndex = 36;
			label6.Text = "giây";
			label4.AutoSize = true;
			label4.Location = new System.Drawing.Point(290, 156);
			label4.Name = "label4";
			label4.Size = new System.Drawing.Size(38, 16);
			label4.TabIndex = 35;
			label4.Text = "video";
			label5.AutoSize = true;
			label5.Location = new System.Drawing.Point(27, 183);
			label5.Name = "label5";
			...
			btnCancel.Location = new System.Drawing.Point(189, 476);
			...
			btnAdd.Location = new System.Drawing.Point(82, 476);
			btnAdd.Name = "btnAdd";
			...
			label15.Location = new System.Drawing.Point(27, 76);
			label15.Name = "label15";
			label15.Size = new System.Drawing.Size(89, 16);
			label15.TabIndex = 31;
			label15.Text = "Nhâ\u0323p tư\u0300 kho\u0301a:";
			...
			txtTuKhoa.TextChanged += new System.EventHandler(richTextBox1_TextChanged);
			...
			base.ClientSize = new System.Drawing.Size(362, 519);
