...
namespace maxcare
{
	public class fHDKetBanTepUidNew : Form
	{
		...
		public fHDKetBanTepUidNew(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDKetBanTepUidNew").Rows.Count == 0)
			{
		...
		private void FConfigInteract_Load(object sender, EventArgs e)
		{
			try
			{
				txtLink.Text = setting.GetValue("txtLink");
		...
		private void txtIdPost_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtLink.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				label5.Text = string.Format(Language.GetValue("Danh sách Link bài viết ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDKetBanTepUidNew));
			...
			txtLink = new System.Windows.Forms.RichTextBox();
			...
			nudDelayFrom.Location = new System.Drawing.Point(134, 109);
			nudDelayFrom.Maximum = new decimal(new int[4] { 999999, 0, 0, 0 });
			nudDelayFrom.Name = "nudDelayFrom";
			nudDelayFrom.Size = new System.Drawing.Size(56, 23);
			nudDelayFrom.TabIndex = 49;
			...
			nudSoLuongFrom.TabIndex = 47;
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(196, 80);
			label3.Name = "label3";
			...
			label5.Location = new System.Drawing.Point(27, 141);
			label5.Name = "label5";
			label5.Size = new System.Drawing.Size(164, 16);
			label5.TabIndex = 31;
			label5.Text = "Danh sách Link bài viết (0):";
			...
			btnCancel.Location = new System.Drawing.Point(189, 373);
			...
			txtLink.Location = new System.Drawing.Point(31, 160);
			txtLink.Name = "txtLink";
			txtLink.Size = new System.Drawing.Size(297, 189);
			txtLink.TabIndex = 57;
			txtLink.Text = "";
			txtLink.WordWrap = false;
			txtLink.TextChanged += new System.EventHandler(txtIdPost_TextChanged);
